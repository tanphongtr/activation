    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, default='', max_length=255, null=True, verbose_name='last name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
                'db_table': 'files',
            },
